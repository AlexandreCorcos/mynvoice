...
<style>
    @page {{
        ...
        @bottom-center {{
            content: "Generated by MYNVOICE \2014  Your business. Your invoices.";
            font-size: 8pt;
            font-family: Helvetica, Arial, sans-serif;
            color: #9aa3af;
            border-top: 0.5pt solid #e8ecef;
            padding-top: 5pt;
            text-align: center;
        }}
    }}
...
<div class="container">
    ...
    <div class="info-row">
        ...
        <div class="info-right">
            ...
            <div class="invoice-number">{_esc(invoice.invoice_number)}</div>
            <div class="meta-item"><strong>Issue Date:</strong> {_format_date(getattr(invoice, 'issue_date', None))}</div>
            <div class="meta-item"><strong>Due Date:</strong> {_format_date(getattr(invoice, 'due_date', None))}</div>
        </div>
    </div>
