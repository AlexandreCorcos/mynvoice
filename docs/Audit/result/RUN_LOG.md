...
|---|---|---|---|---|
| 2026-08-26 | marathon (1–5, all playbooks) | local → prod | 13 items closed & live (v0.23.6–0.23.13 + L6 wildcard removed in Cloudflare); **nothing open** | [file](marathon_2026-08-26.md) |
